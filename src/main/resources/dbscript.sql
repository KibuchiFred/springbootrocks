...
INSERT INTO `springbootrocks`.`app_agency` (`agencyname`, `agencylocation`, `agencyaddress`, `agencyheadname`, `agencyheademail`) VALUES ('Agency5', 'Agency1 Location', 'Agency5 Address', 'Agency5 HeadName', 'Agency5Head@email.com');
...
INSERT INTO `springbootrocks`.`app_programarea` (`programareaname`, `programarealocation`, `programareaaddress`, `programareaheadname`, `programareaheademail`, `programareaagencyid`) VALUES ('Programarea3', 'Programarea3 Location', 'Programarea3 Address', 'Programarea3HeadName', 'Programarea3Head@email.com', '2');
...
INSERT INTO `springbootrocks`.`app_programarea` (`programareaname`, `programarealocation`, `programareaaddress`, `programareaheadname`, `programareaheademail`, `programareaagencyid`) VALUES ('Programarea5', 'Programarea5 Location', 'Programarea5 Address', 'Programarea5HeadName', 'Programarea5Head@email.com', '3');
INSERT INTO `springbootrocks`.`app_programarea` (`programareaname`, `programarealocation`, `programareaaddress`, `programareaheadname`, `programareaheademail`, `programareaagencyid`) VALUES ('Programarea6', 'Programarea6 Location', 'Programarea6 Address', 'Programarea6HeadName', 'Programarea6Head@email.com', '3');
INSERT INTO `springbootrocks`.`app_programarea` (`programareaname`, `programarealocation`, `programareaaddress`, `programareaheadname`, `programareaheademail`, `programareaagencyid`) VALUES ('Programarea7', 'Programarea7 Location', 'Programarea7 Address', 'Programarea7HeadName', 'Programarea7Head@email.com', '4');
INSERT INTO `springbootrocks`.`app_programarea` (`programareaname`, `programarealocation`, `programareaaddress`, `programareaheadname`, `programareaheademail`, `programareaagencyid`) VALUES ('Programarea8', 'Programarea8 Location', 'Programarea8 Address', 'Programarea8HeadName', 'Programarea8Head@email.com', '4');
INSERT INTO `springbootrocks`.`app_programarea` (`programareaname`, `programarealocation`, `programareaaddress`, `programareaheadname`, `programareaheademail`, `programareaagencyid`) VALUES ('Programarea9', 'Programarea9 Location', 'Programarea9 Address', 'Programarea9HeadName', 'Programarea9Head@email.com', '5');
INSERT INTO `springbootrocks`.`app_programarea` (`programareaname`, `programarealocation`, `programareaaddress`, `programareaheadname`, `programareaheademail`, `programareaagencyid`) VALUES ('Programarea10', 'Programarea10 Location', 'Programarea10 Address', 'Programarea10HeadName', 'Programarea10Head@email.com', '5');
